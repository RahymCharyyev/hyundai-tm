          ...
          a = function (t) {
            return function (e, n, a) {
              ...
              if (t && n != n) {
                ...
                for (; u > l; l++) if ((t || l in c) && c[l] === n) return t || l || 0;
              return !t && -1;
            };
          };
      ...
      7475: (t, e, n) => {
        ...
        t.exports = function (t) {
          ...
          return (
            i(t) &&
              ((e = t.constructor),
              ((o(e) && (e === s || i(e.prototype))) || (r(e) && null === (e = e[a]))) &&
                (e = void 0)),
            void 0 === e ? s : e
          );
        };
      ...
      7593: (t, e, n) => {
        ...
        t.exports = function (t, e) {
          ...
          var n,
            c = a(t, l);
          if (c) {
            if ((void 0 === e && (e = 'default'), (n = i(c, t, e)), !o(n) || r(n)))
              return n;
          ...
          function k(t, e, n) {
            ...
            return function (o, r) {
              ...
              for (n.method = o, n.arg = r; ; ) {
                ...
                var c = f(t, e, n);
                if ('normal' === c.type) {
                  if (((i = n.done ? 'completed' : 'suspendedYield'), c.arg === p))
                    continue;
    ...
    (() => {
        ...
        d = function (t) {
          return {
            ...
            filenameX:
              ...
              'image-{index}.jpg',
            filenameY:
              f(t, 'filename-y') || f(t, 'data-filename-y') || 'image-y-{index}.jpg',
            ...
            autoplayBehavior:
              f(t, 'autoplay-behavior') || f(t, 'data-autoplay-behavior') || 'spin-x',
            ...
            lazySelector:
              f(t, 'lazyload-selector') || f(t, 'data-lazyload-selector') || 'lazyload',
      ...
      var H = function (t, e, n) {
          ...
          return t.map(function (t) {
            ...
            return (
              (r.folder = /(http(s?)):\/\//gi.test(t) ? '' : o), (r.filename = t), R(r, n)
            );
          });
        },
        q = function (t, e, n) {
        ...
        et = function (t, e, n, i) {
          ...
          return (
            r > a ? (c = s / r) : (s = c * r),
            {
              ...
              offsetX:
                (t - s) *
                (arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0.5),
              offsetY:
                (e - c) *
                (arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : 0.5),
            }
          );
        },
        nt = function (t, e, n) {
      ...
      function zt(t) {
        for (var e = vt(t), n = Ft(t); n && Mt(n) && 'static' === At(n).position; )
          n = Ft(n);
        return n &&
          ('html' === Ct(n) || ('body' === Ct(n) && 'static' === At(n).position))
          ? e
          : n ||
              (function (t) {
                var e = /firefox/i.test(Ot());
                if (/Trident/i.test(Ot()) && yt(t) && 'fixed' === At(t).position)
                  return null;
                var n = Tt(t);
                for (
                  bt(n) && (n = n.host);
        ...
        if (u) {
          ...
          I === vt(n) &&
            ...
            (o === Nt || ((o === _t || o === Bt) && r === Ut)) &&
              ((w = Vt),
              (m -=
                (d && I === x && x.visualViewport ? x.visualViewport.height : I[O]) -
                i.height),
              (m *= c ? 1 : -1)),
            (o !== _t && ((o !== Nt && o !== Vt) || r !== Ut)) ||
              ((b = Bt),
              (f -=
                (d && I === x && x.visualViewport ? x.visualViewport.width : I[k]) -
                i.width),
              (f *= c ? 1 : -1));
        }
        var E,
          ...
          fn: function (t) {
            ...
            if (r && a) {
              var l = (function (t, e) {
                ...
                f = 'y' === c ? Vt : Bt,
                p =
                  n.rects.reference[u] + n.rects.reference[c] - a[c] - n.rects.popper[u],
      ...
      var De = function (t, e, n) {
          ...
          if (s) {
            var g = (function (t) {
              ...
              return (
                (e.innerText = t), (e.className = 'cloudimage-360-modal-description'), e
              );
            })(s);
            d.appendChild(g);
          }
            ...
            },
            {
              ...
              value: function (t) {
                this.imagesLoaded &&
                  (this.glass && this.closeMagnifier(),
                  37 === t.keyCode &&
                    (this.keysReverse ? this.left() : this.right(), this.onSpin()),
                  39 === t.keyCode &&
                    (this.keysReverse ? this.right() : this.left(), this.onSpin()),
                  this.allowSpinY &&
                    (t.preventDefault(),
                    38 === t.keyCode &&
